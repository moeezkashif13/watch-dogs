...
const First = ()=>{
    ...
    return <div className="px-[45px] bg-[#333639]  w-1/2 tabtolargemob:w-full max-w-[716px] rounded-3xl pt-4 " style={{boxShadow: '0px 1px 50px 0px #0000000A'}}>
...
const Second = ()=>{
    return <div className="  w-1/2 tabtolargemob:w-full max-w-[716px] bg-[#333639] rounded-3xl pt-4">
        ...
        <div className=" px-[45px] mobile:px-8  relative  " style={{boxShadow: '0px 1px 50px 0px #0000000A'}}>



        <div className="absolute mobile:top-[105%] w-[207px] mobile:w-auto mobile:right-8 mobile:text-sm h-[29px] right-0 top-[50px] font-medium text-[20px] leading-7 -tracking-[1.1px]">3M  <span className="text-[#BDBBBB]">/ 6M </span> <span className="text-[#BDBBBB]">/ 12M </span></div>


    <p className="h-[85px] mobile:h-auto font-medium text-[40px] mobile:text-2xl leading-[56px] -tracking-[2px]">Actual Profitability</p>
    
    
    <p className=" h-[85px] mobile:h-auto  largemobtomob:w-auto w-[401px] mobile:text-4xl text-[#2DE93F] font-bold text-[65px] leading-[56px] " style={{textShadow: '7px 7px 12px rgba(0,0,0,0.6)'}}>+$20,457</p>
            

    </div>


    <div className="mt-[55px] space-y-3 h-[324px] pl-[45px] pr-7 overflow-y-scroll seconddesktotab:pb-6">
