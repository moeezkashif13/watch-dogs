...
<div className=' relative border-solid border-[1.3px] border-[#848282]  flex items-center '>



<input type="text" className='w-full py-2 px-[22px] outline-none border-none text-[#949292] placeholder:text-[#949292] font-medium leading-10 text-[17px]' value='romain.bernus@gmail.com'  />

<div className='text-[#B44CD9] font-medium  leading-10 w-[64px] '>Edit</div>
...
<p className='text-[#AA48CD] typo1 absolute -top-[12px]  left-3.5 px-2   leading-6 bg-white'>Password</p>


<input type="text" className='w-full py-2 px-[22px] outline-none border-none text-[#949292] placeholder:text-[#949292] font-medium leading-10 text-[17px]' placeholder='Password' />
